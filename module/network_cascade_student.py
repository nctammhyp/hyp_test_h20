# network_cascade_student.py
# Very small cascade student
...
from module.featurelayer_cascade_student import FeatureLayersStudent
from module.featurelayer import Conv2D
from module.volume_generator_student import GeneratorStudent
from module.corr import CorrBlock1D
from module.update_cascade_student import UpdateBlockStudent
...
class ROmniStereoCascadeStudent(torch.nn.Module):
    def __init__(self, varargin=None):
        super(ROmniStereoCascadeStudent, self).__init__()
        opts = Edict()
        opts.use_rgb = False
        ...
        self.volume_gen = GeneratorStudent(self.opts)
    ...
    def _build_cascade_stages(self):
        ...
        if not stages:
            stages = [
                ...
                {"name": "mid", "downsample": 1, "depth_stride": 1, "iters": 1},
            ]
    ...
    def _build_update_blocks(self):
        ...
        for levels in range(1, int(self.opts.corr_levels) + 1):
            blocks[str(levels)] = UpdateBlockStudent(
                self.opts,
