...
from module.network_cascade_student import ROmniStereoCascadeStudent
...
parser = ArgumentParser(description='Training for ROmniStereo Cascade Student')

parser.add_argument('--name', default='ROmniStereoCascadeStudent', help="name of your experiment")
...
parser.add_argument('--equirect_size', type=int, nargs='+', default=[128, 400], help="size of out ERP.")
...
def train(epoch_total, load_state):
    ...
    net = nn.DataParallel(ROmniStereoCascadeStudent(opts.net_opts)).cuda()
