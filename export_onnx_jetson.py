...
def get_opts():
    ...
    opts.net_opts = Edict({
        'base_channel': 8, # Lưu ý: Bạn dùng 16, code cũ dùng 32. Hãy chắc chắn model .pth được train với 16.
        'num_invdepth': 48, 
        'use_rgb': False, 
...
def main():
    ...
    parser.add_argument('--ckpt_path', type=str, default=r"checkpoints/romnistereo32_v20_bs8_e46.pth", help="Path to .pth checkpoint")
    parser.add_argument('--output_path', type=str, default=r"checkpoints/onnx/romnistereo32_v20_bs8_e46_jetson.onnx", help="Output ONNX file")
