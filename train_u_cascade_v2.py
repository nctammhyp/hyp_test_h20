...
parser = ArgumentParser(description='Training for ROmniStereo Cascade V2')

parser.add_argument('--name', default='ROmniStereoCascadeV2', help="name of your experiment")
...
parser.add_argument('--num_invdepth', type=int, default=32, metavar='N', help='number of disparity')
...
parser.add_argument('--cascade_s2_depth_stride', type=int, default=2)
...
def train(epoch_total, load_state):
    ...
    net = nn.DataParallel(ROmniStereoCascadeV2(opts.net_opts)).cuda()
